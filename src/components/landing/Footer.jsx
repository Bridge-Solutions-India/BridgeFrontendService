        ...
        <div className="w-[92%] max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <img src={logoWhite} alt="Bridge Logo" className="h-12 w-auto" />
                <div className="flex flex-col">
                <span className="text-2xl font-bold tracking-wide leading-none">
                  BRIDGE
                </span>
                  <span className="text-md tracking-widest text-white">
                  Solutions
                </span>
                </div>
              </div>
            ...
            <div>
              ...
              <button
                  ...
                  className="bg-[#1CD2FF] border-2 border-[#1CD2FF] hover:bg-transparent hover:text-[#1CD2FF] cursor-pointer text-[#031226] px-6 py-3 rounded-md flex items-center gap-2 transition-all duration-300 shadow-lg hover:shadow-[#1CD2FF]/30 text-sm font-semibold"
              >
                <svg
                    ref={phoneRef}
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-6">
              {/* LinkedIn */}
              <a href={APP_CONFIG.socials.linkedIn} target="_blank" className="text-[#1CD2FF] hover:text-white">
              ...
              {/* X (Twitter) */}
              <a href={APP_CONFIG.socials.twitter} target="_blank" className="text-[#1CD2FF] hover:text-white">
              ...
              {/* Instagram */}
              <a href={APP_CONFIG.socials.instagram} target="_blank" className="text-[#1CD2FF] hover:text-white">
